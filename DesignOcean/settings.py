"""
Django settings for DesignOcean project.
...
SECRET_KEY = '9v^&oe-7y^@(6#27dsyvz=l1*wn!#irs&1*i4^^ssd)z^__k59'
...
ROOT_URLCONF = 'DesignOcean.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['DesignOcean/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'DesignOcean.wsgi.application'
